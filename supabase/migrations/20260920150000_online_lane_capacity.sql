-- Public booking capacity is the sum of the two active lanes belonging to
-- staff who accept online bookings. A busy lane must not block its sibling.
...
comment on column public.salon_staff.accepts_online_bookings is
  'Public availability and automatic assignment use both active lanes of staff where this value is true.';
